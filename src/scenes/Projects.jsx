  ...
  return (
    <section id="projects" className="pt-48 pb-48">
      ...
      <div className="flex justify-center">
        ...
        >
          <Project title="EcoForecast" subtitle="An app for farmers, ranchers, and land managers to visualize and analyzing future climate and plant ecosystem data. Simulation data generated by STEPWAT2. Made using Google Earth Engine JavaScript API with the Yale School of the Environment." url="https://ecoforecast.info"/>
