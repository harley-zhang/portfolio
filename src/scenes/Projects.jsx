...
const cards = [
  ...
  },
  {
    ...
    description: "Underrepresented NYC communities in local news",
    tools: "React &nbsp;&nbsp; Python &nbsp;&nbsp; deck.gl &nbsp;&nbsp; Google Geocoding API",
    link: "/content-deserts",
    id: 2,
    color: "text-white",
    shadow: "yes",
  },
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="relative">
      ...
      <div
        ref={scrollRef}
        className="flex h-full overflow-x-auto overflow-y-hidden px-5 md:px-[calc(50vw-486px)] no-scrollbar"
