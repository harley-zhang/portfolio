...
const projectData = [
  {
    ...
    description: ["EcoForecast is a web app that allows users to visualize and analyze future ecological changes in the sagebrush habitat across the United States with climate change scenarios. The app uses data generated by the STEPWAT2 simulation model and is built using React and Google Earth Engine JavaScript API.",
