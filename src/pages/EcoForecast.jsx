        ...
        <>
            ...
            <div className="sm:w-[750px] mx-auto px-5">
                <p className="mt-16 xs:mt-20 text-lg">
                    EcoForecast is a web application that allows farmers, ranchers, foresters, and land managers to visualize and analyze future ecological changes in the sagebrush habitat across the United States. The app utilizes data generated using the <a href="https://github.com/DrylandEcology/STEPWAT2" target="_blank" rel="noopener noreferrer" className="transition-all duration-300 decoration-grey-underline hover:decoration-white decoration-1 underline">STEPWAT2 simulation model</a> and is built using React and <a href="https://developers.google.com/earth-engine" target="_blank" rel="noopener noreferrer" className="transition-all duration-300 decoration-grey-underline hover:decoration-white decoration-1 underline">Google Earth Engine JavaScript API</a>.
                </p>
                ...
                <h2 className="text-2xl xs:text-3xl mt-8 xs:mt-12 sm:mt-14">
                    How it works
                </h2>
